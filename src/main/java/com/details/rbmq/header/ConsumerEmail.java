...
public class ConsumerEmail {
    ...
    public static void main(String [] a) {
        ...
        try {
            ...
            map.put("type","email");
            channel.queueBind(QUEUE_INFORM_HEADER_EMAIL,EXCHANGE_HEADER_INFORM,"",map);
            channel.basicQos(1);
            ...
            DefaultConsumer defaultConsumer = new DefaultConsumer(channel){
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    ...
                    logger.info("/-/-/-/-/ Header ConsumerEmail-/-/-/-/-/-/-消息详情为："+s);
                }
            };
            //3.消费
             ...
             */
            logger.info("/-/-/-/-/-/-/-/-/-/-/-开始消费消息");
            channel.basicConsume(QUEUE_INFORM_HEADER_EMAIL, true, defaultConsumer);
            logger.info("/-/-/-/-/-/-/-/-/-/-/-消息消费结束");
        } catch (IOException e) {
            e.printStackTrace();
